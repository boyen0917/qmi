function ObjectDelegate (option) {
			...
			if (withLink) {
				...
				if (direction) {
					...
					link.onclick = function (e) {
						var distance = link.getClientRects()[0].left - breadcrumb.getClientRects()[0].left;
	...
	self.updateStatus = function () {
		...
		console.log(self.selectArea.clientHeight);
		console.log(self.selectArea.offsetHeight);
	}
