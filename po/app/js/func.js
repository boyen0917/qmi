...
detailTimelineContentMake = function (this_event, e_data, reply_chk, triggerDetailBox){
    ...
    $.each(e_data,function(el_i,el){
        ...
        this_event.find(".st-reply-all-content-area").append($('<div>').load('layout/timeline_event.html?v1.8.0.1 .st-reply-content-area', function(){
...
voteContentMake = function (this_event,vote_obj){
    ...
    $.each(li,function(v_i,v_val){
        this_event.find(".st-vote-all-ques-area").append($('<div class="st-vote-ques-area-div">').load('layout/timeline_event.html?v1.8.0.1 .st-vote-ques-area',function(){
